...
teacher_dir1 = './Llama-360M'
teacher_dir2 = './gpt-705M'
...
train_dataset = BabylmDataset("./data/babylm_10M_clean", 
                              SEQ_LENGTH, 
                              tokenizer = tokenizer, 
                              random_chunk = True
                              )
full_eval_dataset = BabylmDataset("./data/babylm_dev_clean", 
                                  SEQ_LENGTH, 
                                  tokenizer = tokenizer, 
                                  offset = 0
                                  )
